...
export class LandingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.streams.push({name: "dentadsio", link: "https://www.twitch.tv/dentadsio", icon: "https://static-cdn.jtvnw.net/jtv_user_pictures/4b22ffa20aa194b9-profile_image-70x70.png"});
  }
